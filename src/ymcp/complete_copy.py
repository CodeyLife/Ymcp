...
COMPLETE_TOOL_BLOCKED_SUFFIX = '若宿主不支持 Elicitation，则统一 menu tool 应返回 blocked，并提供 localhost WebUI fallback，让用户通过 handoff.options 渲染出的真实可交互菜单选择下一步；普通文本列表或 assistant 代渲染不能替代交互选择。'
