...
COMPLETE_TOOL_BLOCKED_SUFFIX = '若宿主不支持 Elicitation，则本 tool 应返回 blocked。'
COMPLETE_HANDOFF_MENU_PREFIX = '宿主现在必须以 `handoff.options` 作为唯一权威菜单数据源，通过 Elicitation 完整展示全部菜单项'
