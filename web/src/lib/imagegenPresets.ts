...
export const IMG2IMG_REFERENCE_GUIDES: Img2ImgReferenceGuide[] = [
  {
    ...
    label: "人物一致性",
    fragment:
      `请把参考图作为“同一人物身份锚点”，生成该人物在全新拍摄状态下的独立照片。

核心目标：只保持同一人物的整体辨识度，让人物能被认出是参考图中的同一个人；新照片的服装、地点、姿势、动作、表情、视线、机位、构图、光线和背景应根据新画面描述重新生成,没有明确描述内容的应该随机变化。

保持：年龄段、肤色范围、脸部比例印象、整体气质、发型大类和人物身份识别度。不要逐项复刻参考图的五官细节、脸部角度、发丝轮廓或微表情。

重新生成：服装、地点、身体姿势、肩颈方向、头部朝向、手部动作、表情、视线方向、镜头距离、拍摄角度、构图重心、光线关系和背景空间。

请主动选择明显不同于参考图的自然方案，让画面像另一次真实拍摄。

不要复制参考图的脸部角度、发丝轮廓、身体姿势、手部位置、构图、背景布局或光线关系。
