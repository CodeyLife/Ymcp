...
export const BUILTIN_NOVEL_SKILLS: NovelSkillManifest[] = [
  ...
  builtin({ skillId: "character-desire-engine", name: "人物欲望引擎", description: "用欲望、恐惧、错误信念、真实需求和代价构造人物。", category: "character-world", stages: ["foundation", "planning", "review", "character-enrichment"], prompt: "为主要人物明确外在欲望、内在恐惧、错误信念、未承认的需求、道德边界和愿意支付的代价。人物选择必须由这些力量推动，而不是服务作者方便。" }),
