...
export const BUILTIN_NOVEL_SKILLS: NovelSkillManifest[] = [
  ...
  builtin({ skillId: "character-voice-matrix", name: "角色声音矩阵", description: "区分角色词汇、句长、回避方式、潜台词与情绪泄露。", category: "character-world", stages: ["drafting", "review", "revision"], prompt: "让角色仅凭对白也可辨认。依据教育、阶层、关系权力、当前目标和回避习惯控制词汇、直接程度、潜台词与沉默。配角不得充当作者点题的传声筒。特殊身份人物除思考特质外，也必须呈现符合处境的身体感受、情绪压力和身份困境。" }),
